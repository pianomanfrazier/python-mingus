...
class test_intervals(unittest.TestCase):
    ...
    def test_diminished_fourth(self):
        minors = {
            'C': 'Fb',
            'Cb': 'Fbb',
            'C#': 'F',
        ...
        for x in minors.keys():
            self.assertEqual(minors[x], intervals.diminished_fourth(x),
                             'The diminished fourth of %s is not %s, expecting %s'
                              % (x, intervals.diminished_fourth(x), minors[x]))
    ...
    def test_diminished_fifth(self):
        minors = {
            'C': 'Gb',
            'Cb': 'Gbb',
            'C#': 'G',
        ...
        for x in minors.keys():
            self.assertEqual(minors[x], intervals.diminished_fifth(x),
                             'The minor fifth of %s is not %s, expecting %s'
                              % (x, intervals.diminished_fifth(x), minors[x]))
